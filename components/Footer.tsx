  ...
  const socialLinks = [
    {
      ...
      glowColor: "group-hover:shadow-[0_0_20px_rgba(0,119,181,0.6)]"
    },
    {
      name: "X",
      ...
      glowColor: "group-hover:shadow-[0_0_20px_rgba(255,255,255,0.4)]"
    },
    {
      name: "Instagram",
    ...
    },
    {
      ...
      hoverColor: "hover:text-makini-soft",
      glowColor: "group-hover:shadow-[0_0_20px_rgba(123,164,208,0.6)]"
    },
    {
      name: "WhatsApp",
      ...
      glowColor: "group-hover:shadow-[0_0_20px_rgba(37,211,102,0.5)]"
    }
  ];

  return (
    <>
      <footer className="bg-makini-navy/95 text-makini-ice/40 pb-12 pt-20 border-t border-white/5 relative overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-8 md:gap-12">
            {socialLinks.map((link) => (
              <a 
                ...
                className={`group relative p-3 rounded-full bg-white/5 border border-white/5 transition-all duration-300 hover:scale-110 ${link.hoverColor} hover:border-current text-makini-ice/60 hover:bg-transparent`}
                aria-label={link.name}
              >
                {/* Glow Effect */}
                <div className={`absolute inset-0 rounded-full opacity-0 transition-opacity duration-300 ${link.glowColor}`}></div>
